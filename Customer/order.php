...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['place_order'])) {
    ...
    $deliveryDate = ($deliveryOption == 'scheduled') ? $_POST['delivery_date'] : date('Y-m-d');

    if ($quantity < 6 || $quantity > 100) {
        echo '<script type="text/javascript">
            alert("The minimum is 6 and the maximum is 100.");
        ...
        if ($conn->query($orderQuery) === TRUE) {
            ...
            if ($conn->query($orderItemQuery) === TRUE && $conn->query($deliveryQuery) === TRUE) {
                echo '<script type="text/javascript">
                    ...
                    <form id="orderForm" action="order.php" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div id="quantityWarning" class="alert alert-danger mt-2" style="display: none;">The minimum is 6 and the maximum is 100.</div>
                            </div>
                            <div class="mb-3">
